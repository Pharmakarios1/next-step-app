    ...
    <Card className="w-full max-w-sm overflow-hidden rounded-2xl shadow-md ">
      ...
      <div className="relative">
        ...
        <div className="absolute top-2 right-2 flex gap-1">
          {badges.map((badge, i) => (
            <Badge key={i} variant="secondary" className="capitalize bg-gradient text-white">
              {badge}
            </Badge>
          ))}
        </div>
      ...
      {/* Content */}
      <CardContent className="py-1 px-4 pt-0 space-y-1">
      ...
      {/* Footer */}
      <CardFooter className="py-1 px-4 flex justify-between items-center gap-2">
        <CustomButton
